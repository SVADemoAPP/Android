...
/**
 * 自定义一个View继承ImageView，增加一个通用的放大缩小图片资源的方法
 * 
 * @author way
 * 
 */
public class CompassViewtran extends ImageView
{
    private float mDirection;// 方向旋转浮点数
    private Drawable compass;// 图片资源

    // 三个构造器
    public CompassViewtran(Context context)
    {
        super(context);
    ...
    public CompassViewtran(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        mDirection = 0.0f;
        compass = null;
    ...
    public CompassViewtran(Context context, AttributeSet attrs, int defStyle)
    {
